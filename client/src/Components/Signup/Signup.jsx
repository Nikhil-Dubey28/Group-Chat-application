          ...
          <div className='form-container'>
            <form className="p-5" onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                ...
                <input type="password" className="form-control" id="password" placeholder="Password" name='password' required onChange={handlePhoneChange}/>
              </div>
              ...
              <button className='btn btn-light rounded-5 w-75 mt-2'>Click here to go to login page</button>
              </div>
